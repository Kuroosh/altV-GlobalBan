...
declare module "natives" {
	...
	*/
	export function setEntityProofs(entity: number, 
: boolean, fireProof: boolean, explosionProof: boolean, collisionProof: boolean, meleeProof: boolean, p6: boolean, p7: boolean, drownProof: boolean): void;
